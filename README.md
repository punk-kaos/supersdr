...
## Main keyboard shortcuts:
  ...
  - **FREQUENCY CONTROL**: **UP/DOWN ARROW KEYS** directly tune the main frequency. By default, this is **0.1 kHz** increments. Hold **SHIFT** for **1 kHz** increments, or hold **CTRL** for **10 Hz** increments for fine tuning.
